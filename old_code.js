...
Vue.component('board', {
    ...
    `,
    data(){
        //данные которые есть в компоненте
        return{
            column_1:[],
            column_2:[],
            column_3:[],
    ...
    mounted(){
        //полусение данных из localstorage для дальнейшего отображения
    ...
    //для загрузки данных из localstorage для дальнейшего просмотра
    watch: {
        column_1(newValue) {
    ...
    //методы для сохранения данных в localstorage
    methods:{
        saveTab_1(){
...
Vue.component('table_1',{
    ...
    methods: {
        ...
        //обновление данных карточки пользователем
        updateTab(tab){
